...
//             wowomartPool.query('SELECT * FROM coupon_user_list', (err, results) => {
...
//     getById: (id) => {
//         return new Promise((resolve, reject) => {
//             wowomartPool.query('SELECT * FROM coupon_user_list WHERE id = ?', [id], (err, results) => {
//                 if (err) return reject({ status: 500, message: err.message });
//                 if (results.length === 0) {
...
//     remove: (id) => {
//         return new Promise((resolve, reject) => {
//             wowomartPool.query('DELETE FROM coupon_user_list WHERE id = ?', [id], (err, result) => {
//                 if (err) return reject({ status: 500, message: err.message });
...
//                             wowomartPool.query('DELETE FROM coupon_user_list WHERE id = ?', [id], (err) => {
